...
class EchartsDataHelper:
    ...
    def get_echarts_json_data(self, is_more_data):
        db_helper = DbHelper(is_more_data)
        ...
        json = {'timestamps': db_helper.timestamps, 'zhqds': db_helper.zhqds,
                ...
                'trade_day': db_helper.trade_day, 'highest': db_helper.highest,
                "num_lianban": db_helper.num_lianban, "num_touch_dieting": db_helper.num_touch_dieting,
